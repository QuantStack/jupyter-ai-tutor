...
/**
 * Computes a line-by-line diff summary between initial starter code and current code.
 */
export function computeDiffSummary(initial: string, current: string): string {
